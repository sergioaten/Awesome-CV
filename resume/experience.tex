...
%---------------------------------------------------------
  %---------------------------------------------------------
  \cventry
    {Hopla Software} % Job title
    {DevOps Engineer} % Organization
    {Madrid} % Location
    {Ago. 2025 -- Actualidad} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Liderazgo técnico en proyectos de infraestructura y plataformas DevOps.}
        \item {Diseño y mantenimiento de pipelines CI/CD con Jenkins, GitHub Actions y GitLab CI.}
        \item {Administración, despliegue y arquitectura de clústeres de HashiCorp Vault (On-Prem y Cloud).}
        \item {Gestión y operación de Kubernetes en entornos híbridos (OnPrem / Cloud).}
        \item {Desarrollo de Helm Charts personalizados adaptados a necesidades específicas de cliente.}
        \item {Implementación de GitOps mediante ArgoCD para despliegue automatizado en Kubernetes.}
        \item {Despliegue y gestión de infraestructura como código utilizando Terraform.}
        \item {Automatización y configuración de servidores mediante Ansible.}
        \item {Observabilidad extremo a extremo: Prometheus, Grafana y Graylog.}
      \end{cvitems}
    }
  %---------------------------------------------------------
  \cventry
